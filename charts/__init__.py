...
from .income import plot_income_by_program_and_year  # Add the import for the new chart
...
CHARTS = {
    ...
    'Income by Program and Year': plot_income_by_program_and_year  # Add this line for the new chart
}
