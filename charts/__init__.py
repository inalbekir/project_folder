...
from .pie import plot_how_students_found_us  # Add the import for the new chart
...
CHARTS = {
    ...
    'How Did You Find Us': plot_how_students_found_us  # Add this line for the new chart
}
